...
namespace Tienda_Virtual.Migrations
{
    ...
    [Migration("20250502022729_BDInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tienda_Virtual.Models.CorreosUsuario", b =>
                {
                    ...
                    b.HasIndex(new[] { "CorreoUsuario" }, "UC_Correo")
                        .IsUnique()
                        .HasFilter("[CorreoUsuario] IS NOT NULL");

                    b.ToTable("CorreosUsuario", (string)null);
                });
            ...
            modelBuilder.Entity("Tienda_Virtual.Models.CorreosUsuario", b =>
                {
                    b.HasOne("Tienda_Virtual.Models.Usuario", "IdUsuarioNavigation")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_IdUsuarioCorreo");
